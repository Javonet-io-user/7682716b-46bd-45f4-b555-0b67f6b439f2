...
import jio.System.Collections.Generic.*;public class SemanticRule {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public ElementPosition getBaseSegmentPosition (){ try { return new ElementPosition((NObject)javonetHandle.<NObject>get("BaseSegmentPosition"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public ElementPosition getDependentSegmentPosition (){ try { return new ElementPosition((NObject)javonetHandle.<NObject>get("DependentSegmentPosition"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public HashSet<java.lang.String> getDefaultValues (){ try { return new HashSet<java.lang.String>((NObject)javonetHandle.<NObject>get("DefaultValues"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public HashSet<java.lang.String> getAcceptedValues (){ try { return new HashSet<java.lang.String>((NObject)javonetHandle.<NObject>get("AcceptedValues"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public HashSet<java.lang.String> getConditionalValues (){ try { return new HashSet<java.lang.String>((NObject)javonetHandle.<NObject>get("ConditionalValues"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public RuleOperator getRuleOperator (){ try { return RuleOperator.valueOf(((NEnum) javonetHandle.<NObject>get("RuleOperator")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
