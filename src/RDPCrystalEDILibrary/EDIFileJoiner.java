...
import jio.System.*;public class EDIFileJoiner extends Component {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public FileJoinLevel getFileJoinLevel (){ try { return FileJoinLevel.valueOf(((NEnum) javonetHandle.<NObject>get("FileJoinLevel")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
