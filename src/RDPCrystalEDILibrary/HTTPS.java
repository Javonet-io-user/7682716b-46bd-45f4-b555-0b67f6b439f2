...
import jio.System.*;public class HTTPS extends Component {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public WebHeaderCollection getHeaders (){ try { return new WebHeaderCollection((NObject)javonetHandle.<NObject>get("Headers"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 */
            public java.lang.String getContentType (){ try { return  (java.lang.String) javonetHandle.get("ContentType");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return "";} }public HTTPS (){  super((NObject) null); try {  javonetHandle = Javonet.New("HTTPS"); super.setJavonetHandle(javonetHandle); javonetHandle.addEventListener("CertificateValidation", new com.javonet.api.INEventListener() {
                    ...
                    {
                        for (CertificateValidationDelegate handler : _CertificateValidationListeners) {handler.Invoke(Convert(objects[0], NObject.class),Convert(objects[1], CertificationEventArgs.class));}}});} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public HTTPS (IContainer container){  super((NObject) null); try {  javonetHandle = Javonet.New("HTTPS",container); super.setJavonetHandle(javonetHandle); javonetHandle.addEventListener("CertificateValidation", new com.javonet.api.INEventListener() {
                    @Override
                    public void eventOccurred(Object[] objects)
                    {
	 ...
	 * Event
	 */
            private java.util.ArrayList< CertificateValidationDelegate> _CertificateValidationListeners = new java.util.ArrayList<CertificateValidationDelegate>();
            ...
            }public interface CertificateValidationDelegate { public void Invoke (NObject sender,CertificationEventArgs e);}	static {
		try {
