...
import jio.System.*;public class EDILightWeightDocument extends Component {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public DocumentCreator getCreator (){ try { return DocumentCreator.valueOf(((NEnum) javonetHandle.<NObject>get("Creator")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public FileStream getFileStream (){ try { return new FileStream((NObject)javonetHandle.<NObject>get("FileStream"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
