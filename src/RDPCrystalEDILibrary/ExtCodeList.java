...
import jio.System.Collections.Generic.*;public class ExtCodeList {protected NObject javonetHandle; /**
	 * GetFiled
	 */
            public static Dictionary<java.lang.String,CodeList> getExternalCodeLists (){ try { return new Dictionary<java.lang.String,CodeList>((NObject)Javonet.getType("ExtCodeList").<NObject>get("ExternalCodeLists"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetFiled
	 */
