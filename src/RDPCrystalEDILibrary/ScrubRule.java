...
import jio.System.Collections.Generic.*;public class ScrubRule {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public List<ScrubPosition> getScrubPositions (){ try { return new List<ScrubPosition>((NObject)javonetHandle.<NObject>get("ScrubPositions"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
