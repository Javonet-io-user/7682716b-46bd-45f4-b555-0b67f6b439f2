...
import jio.System.Xml.*;public class EDIXmlConverter {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public XmlConfigOptions getXmlConfigOptions (){ try { return new XmlConfigOptions((NObject)javonetHandle.<NObject>get("XmlConfigOptions"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
