...
import jio.System.Collections.Generic.*;public class LightWeightElement {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public List<LightWeightElements> getRepeatingCompositeElements (){ try { return new List<LightWeightElements>((NObject)javonetHandle.<NObject>get("RepeatingCompositeElements"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public List<java.lang.String> getRepeatingElementsValues (){ try { return new List<java.lang.String>((NObject)javonetHandle.<NObject>get("RepeatingElementsValues"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
