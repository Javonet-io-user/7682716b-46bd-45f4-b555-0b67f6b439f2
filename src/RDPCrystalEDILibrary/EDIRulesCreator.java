...
import jio.System.Collections.Generic.*;public class EDIRulesCreator extends Component {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public Dictionary<java.lang.String,java.lang.String> getEDIRuleFileData (){ try { return new Dictionary<java.lang.String,java.lang.String>((NObject)javonetHandle.<NObject>get("EDIRuleFileData"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public SortedDictionary<java.lang.String,Segment> getCompositeSegments (){ try { return new SortedDictionary<java.lang.String,Segment>((NObject)javonetHandle.<NObject>get("CompositeSegments"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public LoopSchema getLoopSchema (){ try { return new LoopSchema((NObject)javonetHandle.<NObject>get("LoopSchema"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Loop getMainLoop (){ try { return new Loop((NObject)javonetHandle.<NObject>get("MainLoop"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
