package RDPCrystalEDILibrary;import Common.Activation;import static Common.Helper.Convert;import static Common.Helper.getGetObjectName;import static Common.Helper.getReturnObjectName;import static Common.Helper.ConvertToConcreteInterfaceImplementation;import Common.Helper;import com.javonet.Javonet;
                        ...
                        import com.javonet.api.NControlContainer;import java.util.concurrent.atomic.AtomicReference;import RDPCrystalEDILibrary.*;public class Ack997Generator {protected NObject javonetHandle; /**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public java.lang.Character getPaddingChar (){ try { return javonetHandle.get("PaddingChar");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public Ack997Generator (){ try {  javonetHandle = Javonet.New("Ack997Generator");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public Ack997Generator(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
                    this.javonetHandle = handle;
                }/**
	 * Method
	 */
            public EDIDocument Generate997Acknowledgement (EDIValidator ediValidator){ try { return new EDIDocument((NObject)javonetHandle.invoke("Generate997Acknowledgement",ediValidator));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }	static {
		try {
