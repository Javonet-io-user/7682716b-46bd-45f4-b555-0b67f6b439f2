...
import jio.System.Collections.Generic.*;public class Condition extends Node {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public RuleOperator getOperator (){ try { return RuleOperator.valueOf(((NEnum) javonetHandle.<NObject>get("Operator")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public SegmentPositionNode getFirstOpPosition (){ try { return new SegmentPositionNode((NObject)javonetHandle.<NObject>get("FirstOpPosition"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public SegmentPositionNode getSecondOpPosition (){ try { return new SegmentPositionNode((NObject)javonetHandle.<NObject>get("SecondOpPosition"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public ElementPositionNode getElementPosition (){ try { return new ElementPositionNode((NObject)javonetHandle.<NObject>get("ElementPosition"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetFiled
	 */
            public List<Condition> getoperands (){ try { return new List<Condition>((NObject)javonetHandle.<NObject>get("operands"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetFiled
	 */
	 ...
	 * GetFiled
	 */
            public List<java.lang.String> getoperators (){ try { return new List<java.lang.String>((NObject)javonetHandle.<NObject>get("operators"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetFiled
	 */
