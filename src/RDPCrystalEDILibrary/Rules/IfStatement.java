...
import jio.System.Collections.Generic.*;public class IfStatement extends Node {protected NObject javonetHandle; /**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Condition getCondition (){ try { return new Condition((NObject)javonetHandle.<NObject>get("Condition"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Node getFalse (){ try { return new Node((NObject)javonetHandle.<NObject>get("False"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
            public void setDerivedTrue (Node value){ try { javonetHandle.set("DerivedTrue",value);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }/**
	 * GetProperty
	 */
            public Node getDerivedTrue (){ try { return new Node((NObject)javonetHandle.<NObject>get("DerivedTrue"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public IfStatement (java.lang.String text,java.lang.Integer depth){  super((NObject) null); try {  javonetHandle = Javonet.New("IfStatement",text,depth); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public IfStatement(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
