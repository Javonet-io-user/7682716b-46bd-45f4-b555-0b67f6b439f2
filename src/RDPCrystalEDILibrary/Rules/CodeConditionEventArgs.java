...
import jio.System.Collections.Generic.*;public class CodeConditionEventArgs extends EventArgs {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public CodeCondition getCodeCondition (){ try { return new CodeCondition((NObject)javonetHandle.<NObject>get("CodeCondition"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public DataSegment getCurrentSegmentSchema (){ try { return new DataSegment((NObject)javonetHandle.<NObject>get("CurrentSegmentSchema"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public LightWeightSegment getCurrentSegment (){ try { return new LightWeightSegment((NObject)javonetHandle.<NObject>get("CurrentSegment"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Loop getCurrentLoop (){ try { return new Loop((NObject)javonetHandle.<NObject>get("CurrentLoop"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public FoundSegmentCollection getFoundSegments (){ try { return new FoundSegmentCollection((NObject)javonetHandle.<NObject>get("FoundSegments"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Dictionary<java.lang.Integer,java.lang.String> getFoundElements (){ try { return new Dictionary<java.lang.Integer,java.lang.String>((NObject)javonetHandle.<NObject>get("FoundElements"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
