...
import jio.System.Collections.Generic.*;public class LocalCode extends Node {protected NObject javonetHandle; /**
	 * GetFiled
	 */
            public HashSet<java.lang.String> getValues (){ try { return new HashSet<java.lang.String>((NObject)javonetHandle.<NObject>get("Values"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetFiled
	 */
