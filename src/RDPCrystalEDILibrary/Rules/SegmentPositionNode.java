...
import RDPCrystalEDILibrary.*;public class SegmentPositionNode extends Node {protected NObject javonetHandle; /**
	 ...
	 * GetFiled
	 */
            public ElementPosition getElementPosition (){ try { return new ElementPosition((NObject)javonetHandle.<NObject>get("ElementPosition"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetFiled
	 */
