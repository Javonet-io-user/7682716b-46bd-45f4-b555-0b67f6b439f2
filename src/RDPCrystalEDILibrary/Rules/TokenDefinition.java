...
import jio.System.*;public class TokenDefinition {protected NObject javonetHandle; /**
	 * GetFiled
	 */
            public RegexMatcher getMatcher (){ try { return new RegexMatcher((NObject)javonetHandle.<NObject>get("Matcher"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetFiled
	 */
	 ...
	 * GetFiled
	 */
            public NObject getToken (){ try { return  (NObject) javonetHandle.<NObject>get("Token");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetFiled
	 */
