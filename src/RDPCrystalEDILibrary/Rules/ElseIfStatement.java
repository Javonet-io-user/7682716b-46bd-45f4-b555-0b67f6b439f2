...
import jio.System.Collections.Generic.*;public class ElseIfStatement extends Node {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public Node getTrue (){ try { return new Node((NObject)javonetHandle.<NObject>get("True"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
