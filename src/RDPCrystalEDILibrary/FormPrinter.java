...
import jio.System.Collections.ObjectModel.*;public class FormPrinter extends Component {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public Image getImage (){ try { return ConvertToConcreteInterfaceImplementation((NObject) javonetHandle.<NObject>get("Image"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Bitmap getFormBitmap (){ try { return new Bitmap((NObject)javonetHandle.<NObject>get("FormBitmap"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Color getFontColor (){ try { return javonetHandle.<NObject>get("FontColor");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public PageSettings getPageSettings (){ try { return new PageSettings((NObject)javonetHandle.<NObject>get("PageSettings"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
