...
import jio.System.*;public class DataElement extends LightWeightElement {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public Collection<ElementFormat> getFormatCollection (){ try { return new Collection<ElementFormat>((NObject)javonetHandle.<NObject>get("FormatCollection"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public CodeList getCodeList (){ try { return new CodeList((NObject)javonetHandle.<NObject>get("CodeList"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Dictionary<java.lang.String,java.lang.String> getCodes (){ try { return new Dictionary<java.lang.String,java.lang.String>((NObject)javonetHandle.<NObject>get("Codes"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public ElementDataType getDataType (){ try { return ElementDataType.valueOf(((NEnum) javonetHandle.<NObject>get("DataType")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public DataElements getDataElementDataElementElements (){ try { return new DataElements((NObject)javonetHandle.<NObject>get("DataElementDataElementElements"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
