...
import jio.System.*;public class Loop extends LightWeightLoop {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public Loop getLoopLoopParent (){ try { return new Loop((NObject)javonetHandle.<NObject>get("LoopLoopParent"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public DataSegments getLoopLoopSegments (){ try { return new DataSegments((NObject)javonetHandle.<NObject>get("LoopLoopSegments"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Loops getLoopLoopLoops (){ try { return new Loops((NObject)javonetHandle.<NObject>get("LoopLoopLoops"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
