...
import jio.System.*;public class EDIFileLoader extends Component {protected NObject javonetHandle; /**
	 ...
	 * Event
	 */
            private java.util.ArrayList< EDIFileLoadingCompletedEvent> _FileLoadingCompletedListeners = new java.util.ArrayList<EDIFileLoadingCompletedEvent>();

            public void addFileLoadingCompleted(EDIFileLoadingCompletedEvent toAdd)
            {
                _FileLoadingCompletedListeners.add(toAdd);
            }
            public void removeFileLoadingCompleted(EDIFileLoadingCompletedEvent toRemove)
            {
                _FileLoadingCompletedListeners.remove(toRemove);
            }public interface EDIFileLoadingCompletedEvent { public void Invoke (NObject sender,FileLoadingEventArgs e);}	static {
		try {
