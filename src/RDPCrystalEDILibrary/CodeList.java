...
import jio.System.Collections.Generic.*;public class CodeList {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public Dictionary<java.lang.String,Code> getCodes (){ try { return new Dictionary<java.lang.String,Code>((NObject)javonetHandle.<NObject>get("Codes"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
