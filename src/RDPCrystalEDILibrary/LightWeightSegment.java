package RDPCrystalEDILibrary;import Common.Activation;import static Common.Helper.Convert;import static Common.Helper.getGetObjectName;import static Common.Helper.getReturnObjectName;import static Common.Helper.ConvertToConcreteInterfaceImplementation;import Common.Helper;import com.javonet.Javonet;
	 ...
	 * GetProperty
	 */
            public LightWeightLoop getSegmentLoop (){ try { return new LightWeightLoop((NObject)javonetHandle.<NObject>get("SegmentLoop"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public LightWeightElements getElements (){ try { return new LightWeightElements((NObject)javonetHandle.<NObject>get("Elements"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public LightWeightElement getLastElement (){ try { return new LightWeightElement((NObject)javonetHandle.<NObject>get("LastElement"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public LightWeightElement getFirstElement (){ try { return new LightWeightElement((NObject)javonetHandle.<NObject>get("FirstElement"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public LightWeightSegment (){ try {  javonetHandle = Javonet.New("LightWeightSegment");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public LightWeightSegment (java.lang.String segmentName){ try {  javonetHandle = Javonet.New("LightWeightSegment",segmentName);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public LightWeightSegment(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
