package RDPCrystalEDILibrary;import Common.Activation;import static Common.Helper.Convert;import static Common.Helper.getGetObjectName;import static Common.Helper.getReturnObjectName;import static Common.Helper.ConvertToConcreteInterfaceImplementation;import Common.Helper;import com.javonet.Javonet;
	 ...
	 * GetProperty
	 */
            public SnipTestLevel getSnipLevel (){ try { return SnipTestLevel.valueOf(((NEnum) javonetHandle.<NObject>get("SnipLevel")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public DataSegment getSegmentSchema (){ try { return new DataSegment((NObject)javonetHandle.<NObject>get("SegmentSchema"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public LightWeightSegment getValidatingSegment (){ try { return new LightWeightSegment((NObject)javonetHandle.<NObject>get("ValidatingSegment"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
	 ...
	 * GetProperty
	 */
            public LightWeightSegment getSTSegment (){ try { return new LightWeightSegment((NObject)javonetHandle.<NObject>get("STSegment"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public LightWeightSegment getGSSegment (){ try { return new LightWeightSegment((NObject)javonetHandle.<NObject>get("GSSegment"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public EDIValidationMessage getMessage (){ try { return EDIValidationMessage.valueOf(((NEnum) javonetHandle.<NObject>get("Message")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
