...
import jio.System.*;public class EDIFileSplitter extends Component {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public FileSplitLevel getFileSplitLevel (){ try { return FileSplitLevel.valueOf(((NEnum) javonetHandle.<NObject>get("FileSplitLevel")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
