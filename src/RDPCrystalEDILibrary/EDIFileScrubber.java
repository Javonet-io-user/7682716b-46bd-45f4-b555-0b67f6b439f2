...
import jio.System.*;public class EDIFileScrubber extends Component {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public List<ScrubRule> getScrubRules (){ try { return new List<ScrubRule>((NObject)javonetHandle.<NObject>get("ScrubRules"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * Event
	 */
            private java.util.ArrayList< EDIFileScrubbingCompletedEvent> _FileScrubbingCompletedListeners = new java.util.ArrayList<EDIFileScrubbingCompletedEvent>();
            ...
            }public interface EDIFileScrubbingCompletedEvent { public void Invoke (NObject sender,FileLoadingEventArgs e);}	static {
		try {
