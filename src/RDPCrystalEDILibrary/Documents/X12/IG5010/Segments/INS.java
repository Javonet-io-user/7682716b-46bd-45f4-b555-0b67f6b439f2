...
import RDPCrystalEDILibrary.*;public class INS extends DocumentSegment {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public MedicareStatusCode getMedicareStatusCode (){ try { return new MedicareStatusCode((NObject)javonetHandle.<NObject>get("MedicareStatusCode"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
