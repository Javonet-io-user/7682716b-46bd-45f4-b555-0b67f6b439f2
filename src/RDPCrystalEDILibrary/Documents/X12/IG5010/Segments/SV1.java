...
import RDPCrystalEDILibrary.*;public class SV1 extends DocumentSegment {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public CompositeDiagnosticCodePointer getCompositeDiagnosticCodePointer (){ try { return new CompositeDiagnosticCodePointer((NObject)javonetHandle.<NObject>get("CompositeDiagnosticCodePointer"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
