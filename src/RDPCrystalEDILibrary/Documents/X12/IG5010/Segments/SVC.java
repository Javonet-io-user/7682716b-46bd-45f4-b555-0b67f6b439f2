...
import RDPCrystalEDILibrary.*;public class SVC extends DocumentSegment {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public CompositeMedicalProcedureIdentifier getCompositeMedicalProcedureIdentifier1 (){ try { return new CompositeMedicalProcedureIdentifier((NObject)javonetHandle.<NObject>get("CompositeMedicalProcedureIdentifier1"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public CompositeMedicalProcedureIdentifier getCompositeMedicalProcedureIdentifier2 (){ try { return new CompositeMedicalProcedureIdentifier((NObject)javonetHandle.<NObject>get("CompositeMedicalProcedureIdentifier2"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
