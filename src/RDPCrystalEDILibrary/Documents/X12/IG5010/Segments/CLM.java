...
import RDPCrystalEDILibrary.*;public class CLM extends DocumentSegment {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public HealthCareServiceLocation getHealthCareServiceLocation (){ try { return new HealthCareServiceLocation((NObject)javonetHandle.<NObject>get("HealthCareServiceLocation"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public RelatedCausesInformation getRelatedCausesInformation (){ try { return new RelatedCausesInformation((NObject)javonetHandle.<NObject>get("RelatedCausesInformation"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
