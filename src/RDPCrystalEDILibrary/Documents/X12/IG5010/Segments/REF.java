...
import RDPCrystalEDILibrary.*;public class REF extends DocumentSegment {protected NObject javonetHandle; /**
	 * SetProperty
	 */
	 ...
	 * SetProperty
	 */
            public void setReferenceIdentifier (ReferenceIdentifier value){ try { javonetHandle.set("ReferenceIdentifier",value);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }/**
	 * GetProperty
	 */
            public ReferenceIdentifier getReferenceIdentifier (){ try { return new ReferenceIdentifier((NObject)javonetHandle.<NObject>get("ReferenceIdentifier"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public REF (){  super((NObject) null); try {  javonetHandle = Javonet.New("REF"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public REF(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
