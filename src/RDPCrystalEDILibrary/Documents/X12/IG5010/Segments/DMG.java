...
import RDPCrystalEDILibrary.*;public class DMG extends DocumentSegment {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public RaceOrEthnicityInformation getRaceOrEthnicityInformation (){ try { return new RaceOrEthnicityInformation((NObject)javonetHandle.<NObject>get("RaceOrEthnicityInformation"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
