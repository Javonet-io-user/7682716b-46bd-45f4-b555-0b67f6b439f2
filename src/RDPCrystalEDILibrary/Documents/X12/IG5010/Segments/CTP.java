...
import RDPCrystalEDILibrary.*;public class CTP extends DocumentSegment {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public CompositeUnitOfMeasure getCompositeUnitOfMeasure (){ try { return new CompositeUnitOfMeasure((NObject)javonetHandle.<NObject>get("CompositeUnitOfMeasure"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
