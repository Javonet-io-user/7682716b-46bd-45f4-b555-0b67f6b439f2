...
import RDPCrystalEDILibrary.*;public class STC extends DocumentSegment {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public HealthCareClaimStatus getHealthCareClaimStatus1 (){ try { return new HealthCareClaimStatus((NObject)javonetHandle.<NObject>get("HealthCareClaimStatus1"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public HealthCareClaimStatus getHealthCareClaimStatus2 (){ try { return new HealthCareClaimStatus((NObject)javonetHandle.<NObject>get("HealthCareClaimStatus2"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public HealthCareClaimStatus getHealthCareClaimStatus3 (){ try { return new HealthCareClaimStatus((NObject)javonetHandle.<NObject>get("HealthCareClaimStatus3"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
