...
import RDPCrystalEDILibrary.*;public class SV3 extends DocumentSegment {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public OralCavityDesign getOralCavityDesign (){ try { return new OralCavityDesign((NObject)javonetHandle.<NObject>get("OralCavityDesign"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
