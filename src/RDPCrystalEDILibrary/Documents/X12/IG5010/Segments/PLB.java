...
import RDPCrystalEDILibrary.*;public class PLB extends DocumentSegment {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public AdjustmentIdentifier getAdjustmentIdentifier1 (){ try { return new AdjustmentIdentifier((NObject)javonetHandle.<NObject>get("AdjustmentIdentifier1"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public AdjustmentIdentifier getAdjustmentIdentifier2 (){ try { return new AdjustmentIdentifier((NObject)javonetHandle.<NObject>get("AdjustmentIdentifier2"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public AdjustmentIdentifier getAdjustmentIdentifier3 (){ try { return new AdjustmentIdentifier((NObject)javonetHandle.<NObject>get("AdjustmentIdentifier3"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public AdjustmentIdentifier getAdjustmentIdentifier4 (){ try { return new AdjustmentIdentifier((NObject)javonetHandle.<NObject>get("AdjustmentIdentifier4"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public AdjustmentIdentifier getAdjustmentIdentifier5 (){ try { return new AdjustmentIdentifier((NObject)javonetHandle.<NObject>get("AdjustmentIdentifier5"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public AdjustmentIdentifier getAdjustmentIdentifier6 (){ try { return new AdjustmentIdentifier((NObject)javonetHandle.<NObject>get("AdjustmentIdentifier6"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
