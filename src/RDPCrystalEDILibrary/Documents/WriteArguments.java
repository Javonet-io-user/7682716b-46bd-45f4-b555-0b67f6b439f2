...
import jio.System.Collections.Generic.*;public class WriteArguments {protected NObject javonetHandle; /**
	 ...
	 * GetFiled
	 */
            public List<java.lang.String> getValues (){ try { return new List<java.lang.String>((NObject)javonetHandle.<NObject>get("Values"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetFiled
	 */
