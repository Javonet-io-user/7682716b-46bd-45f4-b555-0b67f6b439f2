...
import jio.System.Net.Security.*;public class CertificationEventArgs extends EventArgs {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public X509Certificate getCertificate (){ try { return new X509Certificate((NObject)javonetHandle.<NObject>get("Certificate"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public X509Chain getChain (){ try { return new X509Chain((NObject)javonetHandle.<NObject>get("Chain"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
