...
import RDPCrystalEDILibrary.Rules.*;public class Segment {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public Collection<ElementRequiredConstraint> getElementRequiredConstraints (){ try { return new Collection<ElementRequiredConstraint>((NObject)javonetHandle.<NObject>get("ElementRequiredConstraints"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Collection<ElementSchema> getElementSchema (){ try { return new Collection<ElementSchema>((NObject)javonetHandle.<NObject>get("ElementSchema"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
