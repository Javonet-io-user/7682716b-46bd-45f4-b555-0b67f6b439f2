...
import jio.System.Collections.ObjectModel.*;public class SelfRule {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public HashSet<java.lang.String> getElementValues (){ try { return new HashSet<java.lang.String>((NObject)javonetHandle.<NObject>get("ElementValues"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Collection<java.lang.Integer> getUsedElementCollection (){ try { return new Collection<java.lang.Integer>((NObject)javonetHandle.<NObject>get("UsedElementCollection"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
