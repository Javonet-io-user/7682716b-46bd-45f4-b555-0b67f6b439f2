package RDPCrystalEDILibrary;import Common.Activation;import static Common.Helper.Convert;import static Common.Helper.getGetObjectName;import static Common.Helper.getReturnObjectName;import static Common.Helper.ConvertToConcreteInterfaceImplementation;import Common.Helper;import com.javonet.Javonet;
	 ...
	 * GetProperty
	 */
            public LightWeightLoop getParent (){ try { return new LightWeightLoop((NObject)javonetHandle.<NObject>get("Parent"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public LightWeightSegments getSegments (){ try { return new LightWeightSegments((NObject)javonetHandle.<NObject>get("Segments"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public LightWeightLoops getLoops (){ try { return new LightWeightLoops((NObject)javonetHandle.<NObject>get("Loops"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public LightWeightSegment getLastSegment (){ try { return new LightWeightSegment((NObject)javonetHandle.<NObject>get("LastSegment"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public LightWeightSegment getFirstSegment (){ try { return new LightWeightSegment((NObject)javonetHandle.<NObject>get("FirstSegment"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public LightWeightLoop (){ try {  javonetHandle = Javonet.New("LightWeightLoop");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public LightWeightLoop (java.lang.String name){ try {  javonetHandle = Javonet.New("LightWeightLoop",name);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public LightWeightLoop(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
