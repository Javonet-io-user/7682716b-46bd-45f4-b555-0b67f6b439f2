...
import RDPCrystalEDILibrary.Rules.*;public class EDIValidator extends Component {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public EDISource getEDISource (){ try { return EDISource.valueOf(((NEnum) javonetHandle.<NObject>get("EDISource")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public EDILightWeightDocument getEDILightWeightDocument (){ try { return new EDILightWeightDocument((NObject)javonetHandle.<NObject>get("EDILightWeightDocument"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
	 ...
	 * GetProperty
	 */
            public EDIRulesReader getEDIRulesReader (){ try { return new EDIRulesReader((NObject)javonetHandle.<NObject>get("EDIRulesReader"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public LightWeightLoop getDataLoop (){ try { return new LightWeightLoop((NObject)javonetHandle.<NObject>get("DataLoop"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public Collection<EDIError> getErrors (){ try { return new Collection<EDIError>((NObject)javonetHandle.<NObject>get("Errors"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public Collection<EDIWarning> getWarnings (){ try { return new Collection<EDIWarning>((NObject)javonetHandle.<NObject>get("Warnings"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
	 ...
	 * GetFiled
	 */
            public List<LightWeightSegment> getValidatedTransactions (){ try { return new List<LightWeightSegment>((NObject)javonetHandle.<NObject>get("ValidatedTransactions"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetFiled
	 */
            public void setValidatedTransactions (List<LightWeightSegment> param){ try { javonetHandle.set("ValidatedTransactions",param);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public EDIValidator (IContainer container){  super((NObject) null); try {  javonetHandle = Javonet.New("EDIValidator",container); super.setJavonetHandle(javonetHandle); javonetHandle.addEventListener("OnCodeCondition", new com.javonet.api.INEventListener() {
                    ...
                    {
                        for (CodeConditionEvent handler : _OnCodeConditionListeners) {handler.Invoke(Convert(objects[0], NObject.class),Convert(objects[1], CodeConditionEventArgs.class));}}});javonetHandle.addEventListener("ProgressChanged", new com.javonet.api.INEventListener() {
                    @Override
                    public void eventOccurred(Object[] objects)
                    {
                        for (GeneralEvent handler : _ProgressChangedListeners) {handler.Invoke(Convert(objects[0], java.lang.Integer.class));}}});javonetHandle.addEventListener("ValidationCompleted", new com.javonet.api.INEventListener() {
                    @Override
                    public void eventOccurred(Object[] objects)
                    {
                        for (ValidationCompletedEvent handler : _ValidationCompletedListeners) {handler.Invoke(Convert(objects[0], NObject.class),Convert(objects[1], ValidationEventsArgs.class));}}});javonetHandle.addEventListener("ValidationStarted", new com.javonet.api.INEventListener() {
                    @Override
                    public void eventOccurred(Object[] objects)
                    {
                        for (ValidationStartedEvent handler : _ValidationStartedListeners) {handler.Invoke(Convert(objects[0], NObject.class));}}});} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public EDIValidator (){  super((NObject) null); try {  javonetHandle = Javonet.New("EDIValidator"); super.setJavonetHandle(javonetHandle); javonetHandle.addEventListener("OnCodeCondition", new com.javonet.api.INEventListener() {
                    @Override
                    public void eventOccurred(Object[] objects)
                    {
                        for (CodeConditionEvent handler : _OnCodeConditionListeners) {handler.Invoke(Convert(objects[0], NObject.class),Convert(objects[1], CodeConditionEventArgs.class));}}});javonetHandle.addEventListener("ProgressChanged", new com.javonet.api.INEventListener() {
	 ...
	 * Event
	 */
            private java.util.ArrayList< CodeConditionEvent> _OnCodeConditionListeners = new java.util.ArrayList<CodeConditionEvent>();

            public void addOnCodeCondition(CodeConditionEvent toAdd)
            {
                _OnCodeConditionListeners.add(toAdd);
            }
            public void removeOnCodeCondition(CodeConditionEvent toRemove)
            {
	 ...
	 * Event
	 */
            private java.util.ArrayList< ValidationStartedEvent> _ValidationStartedListeners = new java.util.ArrayList<ValidationStartedEvent>();

            public void addValidationStarted(ValidationStartedEvent toAdd)
            {
                _ValidationStartedListeners.add(toAdd);
            }
            public void removeValidationStarted(ValidationStartedEvent toRemove)
            {
                _ValidationStartedListeners.remove(toRemove);
            }public interface GeneralEvent { public void Invoke (java.lang.Integer progress);}public interface ValidationStartedEvent { public void Invoke (NObject sender);}public interface ValidationCompletedEvent { public void Invoke (NObject sender,ValidationEventsArgs e);}public interface CodeConditionEvent { public void Invoke (NObject sender,CodeConditionEventArgs e);}	static {
		try {
