...
import jio.System.Drawing.*;public class FormCell {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public StringFormatFlags getStringFormatFlags (){ try { return StringFormatFlags.valueOf(((NEnum) javonetHandle.<NObject>get("StringFormatFlags")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public StringAlignment getStringAlignment (){ try { return StringAlignment.valueOf(((NEnum) javonetHandle.<NObject>get("StringAlignment")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public StringAlignment getLineAlignment (){ try { return StringAlignment.valueOf(((NEnum) javonetHandle.<NObject>get("LineAlignment")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
