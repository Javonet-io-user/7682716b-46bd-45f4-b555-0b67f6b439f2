...
import jio.System.Collections.Generic.*;public class ElementValueInfo {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public HashSet<java.lang.String> getPossibleValues (){ try { return new HashSet<java.lang.String>((NObject)javonetHandle.<NObject>get("PossibleValues"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
