...
import jio.System.Collections.ObjectModel.*;public class LoopSchema {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public LoopSchema getParent (){ try { return new LoopSchema((NObject)javonetHandle.<NObject>get("Parent"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Collection<LoopSchema> getLoops (){ try { return new Collection<LoopSchema>((NObject)javonetHandle.<NObject>get("Loops"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
