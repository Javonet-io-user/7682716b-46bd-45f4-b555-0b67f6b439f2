...
import jio.System.Collections.ObjectModel.*;public class Mask {protected NObject javonetHandle; /**
	 * GetProperty
	 */
            public List<java.lang.String> getMaskData (){ try { return new List<java.lang.String>((NObject)javonetHandle.<NObject>get("MaskData"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public Collection<Usage> getUsages (){ try { return new Collection<Usage>((NObject)javonetHandle.<NObject>get("Usages"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public Mask (){ try {  javonetHandle = Javonet.New("Mask");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public Mask(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
